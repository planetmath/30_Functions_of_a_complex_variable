...
\usepackage{pmmeta}
\pmcanonicalname{SimplePole}
\pmcreated{2013-03-22 13:15:55}
\pmmodified{2013-03-22 13:15:55}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A \emph{simple pole} is a pole of order 1.  That is, a meromorphic function $f$ has a simple pole at
$x_0\in\C$ if $$f(z)=\frac a{z-x_0}+g(z)$$ where $a\neq 0\in\C$, and $g$ is holomorphic at $x_0$.

Note that $a$ in the equation above is the residue of $f$ at $x_0$.
%%%%%
%%%%%
\end{document}
