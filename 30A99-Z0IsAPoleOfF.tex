...
\usepackage{pmmeta}
\pmcanonicalname{Z0IsAPoleOfF}
\pmcreated{2013-03-22 14:00:55}
\pmmodified{2013-03-22 14:00:55}
\pmowner{drini}{3}
\pmmodifier{drini}{3}
\pmtitle{$z_0$ is a pole of $f$}
\pmrecord{7}{34919}
\pmprivacy{1}
\pmauthor{drini}{3}
\pmtype{Definition}
...
%% \include{argawarga}
\begin{document}
Let $f$ be an analytic function on a punctured neighborhood of $x_0\in\C$,
that is, $f$ analytic on \[\{z\in C: 0<|z-x_0|<\varepsilon\}\]
